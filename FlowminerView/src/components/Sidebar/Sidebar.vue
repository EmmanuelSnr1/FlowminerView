<template>
  <nav
    class="md:left-0 md:block md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden shadow-xl bg-sidebar flex flex-wrap items-center justify-between relative md:w-64 z-10 py-4 px-6"
  >
    <div
    ...
    >
      ...
      <button
        ...
        type="button"
        @click="toggleCollapseShow('bg-blue-500 m-2 py-3 px-6')"
      >
      ...
      >
        ...
        <form class="mt-6 mb-4 md:hidden">
          <div class="mb-3 pt-0">
            <input
              type="text"
              placeholder="Search"
              class="px-3 py-2 h-12 border border-solid border-blueGray-500 placeholder-blueGray-300 text-white bg-white rounded text-base leading-snug shadow-none outline-none focus:outline-none w-full font-normal"
            />
          </div>
        </form>
        ...
        <!-- Heading -->
        <h6
          class="md:min-w-full text-gray-300 text-xs uppercase font-bold block pt-1 pb-4 no-underline"
        >
          Auth Layout Pages
        </h6>
        <!-- Navigation -->
        ...
        <ul class="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
          <li class="items-center">
            <router-link
              class="text-gray-200 hover:text-gray-300 text-xs uppercase py-3 font-bold block"
              to="/auth/login"
            >
        ...
        <ul class="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
          <li class="inline-flex">
            <a
              ...
              target="_blank"
              class="text-gray-200 hover:text-gray-300 text-sm block mb-4 no-underline font-semibold"
            >
